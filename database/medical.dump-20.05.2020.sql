...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 20 2020 г., 22:12
...
INSERT INTO `clients` (`id`, `fio`, `registration`, `bday`, `phone`) VALUES
(1, 'Иванов Иван Иванович', 'Улица Пушкина, дом 14', '2020-05-06', '+7(902)434-04-10');
...
(1, 'Удаление зуба', 1300, 30),
(2, 'Профилактический осмотр', 500, 15);
...
INSERT INTO `stuff` (`id`, `fio`, `spec`, `time`) VALUES
(1, 'Иванов Иван Иванович', 'Стоматолог', 30);
